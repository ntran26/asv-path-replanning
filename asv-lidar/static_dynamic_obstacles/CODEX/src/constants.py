...
**CODEX revision 3** — one dynamic target and five encounter classes, with
70 observation values including explicit encounter memory and executed action.
...
OBSERVATION_SCHEMA_VERSION = "codex-v3-context"
...
# Completion includes returning to the path after avoidance. The inherited
# 1.60 m tolerance ended diagonal recovery before the vessel could recenter.
GOAL_CTE_RADIUS = 0.60
...
# ===========================================================================
# Six branches feed the CODEX MultiInputPolicy, including encounter context. The
